...
# Define custom .strong {cli} classes to be used in creating/storing {joyn} messages
...
# Class `strong.var` - to highlight variables/column names
cli::cli_div(theme = list(
...
# Class `strong.table` - to highlight data tables/frames (e.g., x or y)
cli::cli_div(theme = list(
...
# Class `strong.arg` - to highlight function arguments (e.g., suffixes, match type)
cli::cli_div(theme = list(
