...
Since the objective of joyn is to join tables with joy, there is only
one main function in this package
...
- [`full_join()`](https://randrescastaneda.github.io/joyn/reference/full_join.md)
  : Full join two data frames
- [`right_join()`](https://randrescastaneda.github.io/joyn/reference/right_join.md)
  : Right join two data frames
- [`left_join()`](https://randrescastaneda.github.io/joyn/reference/left_join.md)
  : Left join two data frames
- [`inner_join()`](https://randrescastaneda.github.io/joyn/reference/inner_join.md)
  : Inner join two data frames
- [`anti_join()`](https://randrescastaneda.github.io/joyn/reference/anti_join.md)
...
- [`get_joyn_options()`](https://randrescastaneda.github.io/joyn/reference/get_joyn_options.md)
  : Get joyn options
- [`set_joyn_options()`](https://randrescastaneda.github.io/joyn/reference/set_joyn_options.md)
  : Set joyn options
...
- [`rename_to_valid()`](https://randrescastaneda.github.io/joyn/reference/rename_to_valid.md)
