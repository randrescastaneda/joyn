...
However, the benefits of **preventing errors and gaining invaluable
insights** far outweigh the minor speed difference.
...
- [`joyn::merge()`](https://randrescastaneda.github.io/joyn/reference/merge.md):
  Leverage familiar base R and `data.table` syntax for seamless
